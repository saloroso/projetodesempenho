    ...
    function enviarFormulario(){
        ...
        alert ("Função de enviar formulário acessada 11");
        ...
        if ((auto1<0) || (auto1>100) || (auto2<0) || (auto2>100) || (auto3<0) || (auto3>100)
            ...
            || (ini1<0) || (ini1>100) || (ini2<0) || (ini2>100) || (ini3<0) || (ini3>100)
              ...
              var media_auto = (auto1 + auto2 + auto3);
              var media_comu = (comu1 + comu2 + comu3);
              var media_disc = (disc1 + disc2 + disc3);
              var media_flex = (flex1 + flex2 + flex3);
              var media_foco = (foco1 + foco2 + foco3);
              var media_rel = (rel1 + rel2 + rel3);
              var media_ini = (ini1 + ini2 + ini3);    
