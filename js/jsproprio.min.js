    ...
    function Criaradm(nome, email, senha){
        ...
        this.notadaequipe = function(){
            ...
            // calcular nota da equipe e retornar o valor por return.
        }
    }

    // Função para criar segundo tipo de administrador, pelo site.
    function Cadastraradm2(){
          
          alert ("Entrei na função cadastrar adm2 12");
          ...
          for (r=0;r<tamanho6;r++){
                if ((listadeadms[r].nome==nome1) || (listadeadms[r].email==email1) || (nome=="") || (email=="") || (senha=="")){
                      
                      alert ("Nome de Usuário ou E-mail já se encontram cadastrados, favos registrar-se com outros dados.");                                                               
                      
                } else {
                     var novousuario = new Criaradm (nome1, email1, senha1);
                     listadeadms.push(novousuario);
                      
                     alert ("Novo usuário cadastrado.");
                      
                      // nao esta criando usuario adequadamente. Alias, está, mas sem verificar se ele já existe. Pode ser algo como inserção com string ou não.
                      // também não é possível logar com os novos usuários. Não tinha usado o New antes do criar adm, talvez com isso resolva.
                }     
          } 
    }
    ...
    var master = new Criaradm ("Master","master@gmail.com", "master")
