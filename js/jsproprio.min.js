...
function teste(){
      alert ("Se botão está funcionando.");
}
...
/*
 ...
 // -- FUNÇÃO PARA CRIAR NOVO ADMINISTRADOR/LÍDER, SEJA ELE MASTER OU NÃO --------------------- // 
  ...
  // -- VERIFICAR SE O ADM JÁ ESTÁ CADASTRADO NO BANCO DE DADOS --------------------- // 
     function Verifica_Adm(nome1,email1,senha1){            
          var listadeadms = sessionStorage.getItem("BANCO_ADMS");
          listadeadms = JSON.parse(listadeadms);           
  ...
  // -- FUNÇÃO PARA CADASTRAR ADM NO BANCO DE DADOS --------------------- // 
    function Cadastrar_Adm(){     
          ...
          var verificar = Verifica_Adm(nome1,email1,senha1);
          if (verificar==true){
               var novo_user = new Criar_adm(nome1,email1,senha1);
               listadeadms.push(novo_user);
               alert ("Usuário cadastrado com sucesso.");
               Salvar_Bancodeadms(listadeadms);  
          }
    }
   */ /*
  // -- FUNÇÃO PARA LOGAR NO BANCO DE DADOS --------------------- // 
    function Logar_Adm(){ 
        alert ("Entrou na função log adm").
        listadeadms = sessionStorage.getItem("BANCO_ADMS");
        listadeadms = JSON.parse(listadeadms);            
        usuariologado = sessionStorage.getItem("USUARIO_LOGADO");
    ...
    function Processar_Formulario(){   
        ...
        if ((auto1<0) || (auto1>100) || (auto2<0) || (auto2>100) || (auto3<0) || (auto3>100)
            ...
            || (ini1<0) || (ini1>100) || (ini2<0) || (ini2>100) || (ini3<0) || (ini3>100)
              ...
              var resultado = Verificar_Formulario(codigodorespondente,nomedorespondente,liderdorespondente);            
