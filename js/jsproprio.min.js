    ...
    function enviarFormulario(){
        ...
        alert ("Função de enviar formulário acessada 5");
        ...
        if ((auto1 < 0) || (auto2 > 100) ){
            alert ("Alguma(s) da(s) nota(s) digitadas é menor que zero ou maior que cem, favor adequá-los");
        } else { alert("Todas as notas estão entre 0 e 100, o formulário foi preenchido corretamente");}
