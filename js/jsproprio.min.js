  ...
  // -- FUNÇÃO PARA CADASTRAR ADM NO BANCO DE DADOS --------------------- // 
    function Cadastrar_Adm(lista1){ 
          ...
          if (verificar==true){
               ...
               document.getElementById("Disparador_Modal").setAttribute("data-target", "#basicExampleModal2");       
          } else {
    ...
    function Logar_Adm(lista1){ 
        ...
        for (i=0;i<tamanho;i++){            
            if ((lista[i].email==emailadm) && (lista[i].senha==senhaadm)) {
                ...
                window.location.href="https://saloroso.github.io/projetodesempenho/portaladm"; 
                return true;
            } 
        }
