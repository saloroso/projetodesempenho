    ...
    function Cadastraradm2(){
          ...
          alert ("20 - Entrando, lendo e armazenando ok. Listadeadms aumenta com push. For correto quando nome e email são iguais.");
          ...
          for (r=0;r<tamanho6;r++){
                ...
                if (((nome1=="") || (email1=="") || (senha1=="")){      
                    ...
                    r=tamanho6; // iguala r com tamanho para não ficar repetindo conforme tamanho e assim sair da função.
                
                    } else if ((listadeadms[r].nome==nome1) || (listadeadms[r].email==email1)){
                    alert ("Nome de usuário ou senha já se encontram cadastrados.");
                    r=tamanho6; // iguala r com tamanho para não ficar repetindo conforme tamanho e assim sair da função.
                      
                } else {
                      alert ("Todos os campos válidos para cadastrar.");
                      var novousuario = new Criaradm (nome1, email1, senha1);
                      listadeadms.push(novousuario); 
                } // fechamento do else.   
                }   
          } //fechamento do for. 
    } //fechamento da função de cadastro.
