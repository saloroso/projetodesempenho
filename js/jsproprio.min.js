 ...
 // -- FUNÇÃO PARA CRIAR RESPONDENTE DE UM LIDER --------------------- // 
  ...
  // -- VERIFICAR SE O MEMBRO JÁ ESTA NA LISTA DE MEMBROS DO ADMINISTRADOR --------------------- // 
      function Verificar_Membro(codigo2, lista){
          ...
          for (i=0;i<tamanho;i++){
              alert ("Entrei na função para verificar se código já existe.");
              var tamanho_membros = lista2[i].membros.length; 
              for (j=0;j<tamanho_membros;j++){
                  if (lista2[i].membros[j].codigo == codigo2){
                      alert ("Código já existe.");
                      return false;
                  }
              }
          }
          alert ("Código não existe, pode cadastrar.");
          return true;
      }
