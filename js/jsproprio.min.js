    ...
    function logarAdm(){   
        ...
        for (i=0;i<tamanho;i++){            
            if ((listadeadms[i].email==emailadm) && (listadeadms[i].senha==senhaadm)) {
                ...
                alert ("Entrei no loop 5");
                window.location = "https://www.saloroso.github.io/projetodesempenho/formulario";
                window.location.href = "https://www.saloroso.github.io/projetodesempenho/formulario";
                self.location = "https://www.saloroso.github.io/projetodesempenho/formulario";
            } else {
