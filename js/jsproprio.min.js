            ...
            if (listadeadms[i].nome==liderdorespondente){
                ...
                for (j=0;j<tamanholistarespondentes;j++){
                    if (listadeadms[i].membros==nomedorespondente){
                        ...
                        } else {alert ("O código não se encontra cadastrado");}                         
                    } else {alert ("O nome do respondente não se encontra cadastrado");}
            } else { alert ("O líder digitado não se encontra cadastrado");} 
         }
        }
