    ...
    function enviarFormulario(){
        ...
        alert ("Função de enviar formulário acessada 2");
        
        // Captura de todas as variáveis preenchidas.
        ...
        alert ("Teste 2 até o meio.");
        
        // verificação de todas as variáveis preenchidas.
       if (auto1 < 0 || auto1 > 100 || auto2 < 0 || auto2 > 100 || auto3 < 0 || auto3 > 100
        ...
        || ini1 < 0 || ini1 > 100 || ini2 < 0 || ini2 > 100 || ini3 < 0 || ini3 > 100) {
           alert ("Alguma(s) da(s) nota(s) estão abaixo de 0 ou acima de 100, favor adequá-las para prosseguir");}
        else { alert "Não foram encontrados erros");}
        
        alert ("Teste 2 até o final.");
