    ...
    listadeadms.push(master);
        ...
        // Inserção de respondentes default no usuario principal do adm.
    var usuario1 = ("usuario1", "codigo1", "Master", 50, 60, 70, 25, 67, 89, 45, 58)
    var usuario2 = ("usuario2", "codigo2", "Master", 40, 30, 80, 24, 63, 89, 14, 48)
    var usuario3 = ("usuario3", "codigo3", "Master", 56, 78, 80, 22, 33, 76, 17, 51)
    ...
    function enviarFormulario(){
        ...
        alert ("Função de enviar formulário acessada 18");
        ...
        if ((auto1<0) || (auto1>100) || (auto2<0) || (auto2>100) || (auto3<0) || (auto3>100)
            ...
            || (ini1<0) || (ini1>100) || (ini2<0) || (ini2>100) || (ini3<0) || (ini3>100)
              ...
              var media_geral = (media_auto + media_comu + media_disc + media_flex + media_foco + media_rel + media_ini)/7;
                                          
              alert ("Realizado a captura da string, conversão para número e consolidação nas médias.");
              alert (media_geral);
              
              var testepessoa = listadeadms[0].membros[0].media_geral;
              alert (testepessoa);
