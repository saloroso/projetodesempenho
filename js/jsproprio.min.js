    ...
    function Cadastraradm2(){
          ...
          alert ("Entrei na função cadastrar adm2 3");
          
          var nome = document.getElementById("Nome").value;
          var email = document.getElementById("E-mail").value;
          var senha = document.getElementById("Senha").value;      
          
          tamanho6 = listadeadms.length;
                            
          for (r=0;r<tamanho6;r++){
                if ((listadeadms[r].nome==nome) || (listadeadms[r].email==email) || (nome==null) || (email==null) || (senha==null)){
                      
                      alert ("Nome de Usuário ou E-mail já se encontram cadastrados, favos registrar-se com outros dados.");                                                               
                      
                } else {
                     var novousuario = Criaradm(nome, email, senha);
