    ...
    function Cadastraradm2(){
          ...
          alert ("15 - Entrando, lendo e armazenando ok. Listadeadms aumenta com push. For correto quando nome e email são iguais");
          ...
          for (r=0;r<tamanho6;r++){
                if ((listadeadms[r].nome==nome1) || (listadeadms[r].email==email1) || (nome=="") || (email=="") || (senha=="")){
                      ...
                      alert ("Entrando na condição do for");
                     ...
                     alert ("Entrando na condição do for, mas no else.");
