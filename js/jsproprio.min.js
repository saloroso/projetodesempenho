    ...
    function enviarFormulario(){
        ...
        alert ("Função de enviar formulário acessada 21");
        ...
        if ((auto1<0) || (auto1>100) || (auto2<0) || (auto2>100) || (auto3<0) || (auto3>100)
            ...
            || (ini1<0) || (ini1>100) || (ini2<0) || (ini2>100) || (ini3<0) || (ini3>100)
              ...
              alert ("Auto" + media_auto);
              alert ("Comu" + media_comu);
              alert ("Disc" + media_disc);
              alert ("Flex" + media_flex);
              alert ("Foco" + media_foco);
              alert ("Rel" + media_rel);
              alert ("Ini" + media_ini);
              alert ("Geral" + media_geral);
              alert (media_auto);
